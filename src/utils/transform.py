...
transform = v2.Compose([
    ...
    v2.RandomResizedCrop(size=(640, 640), scale=(0.7, 1.0), ratio=(3/4, 4/3), antialias=True),
    ...
    v2.RandomErasing(p=0.2, scale=(0.02, 0.2), ratio=(0.3, 3.3), value="random"), # type: ignore
