...
def test_dataset_loader():
    ...
    assert a.shape == (
        ...
        640,
        640,
    ), "Неверная форма anchor_image с train_transform"
    assert p.shape == (
        batch_size,
        3,
        640,
        640,
    ), "Неверная форма positive_image с train_transform"
    assert n.shape == (
        batch_size,
        3,
        640,
        640,
    ), "Неверная форма negative_image с train_transform"
    ...
    assert a.shape == (
        ...
        640,
        640,
    ), "Неверная форма anchor_image с base_stransform"
    assert p.shape == (
        batch_size,
        3,
        640,
        640,
    ), "Неверная форма positive_image с base_stransform"
    assert n.shape == (
        batch_size,
        3,
        640,
        640,
    ), "Неверная форма negative_image с base_stransform"
